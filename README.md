...
## Hardware rambling
The PCB is a 100x100mm 4 layer board using 1 Oz copper for the outer layers and 0.5 Oz copper for the inner layers (the cheapest specs from JLCPCB).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzAwMDIzOTFdfQ==
-->